...
import { Icon, RadioGroup, Radio, DatePicker, SelectPicker,Table } from 'rsuite';
import {StockStat,CategoryStat,VisitStat} from "./index";
...
class StatsList extends React.Component {
    ...
    render() {
        ...
        switch (statItem) {
            ...
            case 4:
                zone = (<div className="stat_zone">
                    <CategoryStat isFetching={isCategoryFetching} data={categoryStat} />
                </div>);
                  search_bar=(<tbody>
                    <tr>
                        <td>日期范围</td>
                        ...
                        <td>
                            <Field name="keyword" placeholder="药名、通用名、拼音" data={employees} onChange={(value)=>{
                                this._onDateRangeChanged(null,null,null,value);
                            }} />
                        </td>
                        <td>
            ...
            case 5:
                zone = (<div className="stat_zone">
                    ...
                    <StockStat isFetching={isStockFetching} data={stocksStat}  />
                </div>);
                search_bar = (<tbody>
                    <tr>
                        <td>药品</td>
